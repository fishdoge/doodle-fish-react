export default function getCurrentColor(score: number) {
  ...
  if (score < 25) return { background: 0xe8_e4_f7, spike: 0X4EB3FF }
  if (score < 30) return { background: 0x76_76_75, spike: 0X4EB3FF }
  if (score < 35) return { background: 0x2b_69_7f, spike: 0X0075DC }
  if (score < 40) return { background: 0x1e_72_00, spike: 0X0075DC }
